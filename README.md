...
Separate native macOS Apple Silicon and Intel DMGs and a Windows x64 ZIP with bundled Node are available through the local-client release workflow. See [installation and preview limitations](docs/INSTALL_LOCAL.md). The macOS preview is ad-hoc signed and is not notarized.
