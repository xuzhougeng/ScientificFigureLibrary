...
test("runtime Provider order is Local, bundled Community, FigureYa, then canonical personal ids", async () => {
  ...
  try {
    ...
    assert.deepEqual(
      ...
      [LOCAL_LIBRARY_PROVIDER_ID, COMMUNITY_PROVIDER_ID, FIGUREYA_PROVIDER_ID],
    );
  } finally {
